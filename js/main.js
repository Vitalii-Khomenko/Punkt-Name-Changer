...
function renderPatternConfig(patterns) {
    ...
    if (!patterns || patterns.length === 0) {
        ...
        empty.textContent = 'No supported patterns found in master (expected G01.001..G10.998, P01.001..P10.998, Q01.001..Q10.998, or QL01.001..QL10.998).';
...
async function analyzeCurrentMaster() {
    ...
    try {
        ...
        if (detectedPatterns.length > 0) {
            ...
            logWarning('No dot-format patterns detected in master. Expected G01.001..G10.998, P01.001..P10.998, Q01.001..Q10.998, and/or QL01.001..QL10.998.');
        }
    } catch (e) {
        console.error(e);
