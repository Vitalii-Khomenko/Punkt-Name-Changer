...
| --- | --- |
| Numeric Leica ID normalization | The Python preprocessor converts `101.1` to `G01.001`, preserves fixed-width bytes and CRLF endings, and leaves `101.EX.01` unchanged. |
